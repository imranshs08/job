...
4. Save the output as a new `.md` file inside `10-AI-Learning-Roadmap/` for revision.

### 💡 Suggested Output File Naming Convention
```
10-AI-Learning-Roadmap/
├── W01-foundation-raw-api.md
├── W02-claude-sdk.md
├── W03-tool-use-mcp.md
├── W04-hooks-guardrails-security.md
├── W05-multi-agent-architecture.md
├── W06-memory-sessions.md
├── W07-structured-output.md
├── W08-skills-chaining.md
├── W09-mcp-deep-dive.md
├── W10-model-economics.md
├── W11-managed-agents.md
└── claude-cert-study-prompt.md   ← (this file)
```
...
|---|---|---|---|
| `stop_reason` | string | Why Claude stopped generating (`end_turn`, `tool_use`, `max_tokens`) | ⚠️ Yes |
| `model` | string | Which Claude model processed the request | |
| `usage.input_tokens` | int | Tokens consumed from input (affects cost) | ⚠️ Yes |
| `usage.output_tokens` | int | Tokens generated in response | |
| [all relevant fields] | | | |
