...
lessons = [
    ...
    # === SCHEDULING (37 topics incl. 2025 Admission Controllers update) ===
    ("Scheduling", "Scheduling Section Introduction", "00:54"),
    ("Scheduling", "Manual Scheduling", "02:31"),
    ("Scheduling", "Practice Test Manual Scheduling", ""),
    ("Scheduling", "Solution: Manual Scheduling (optional)", "03:22"),
    ("Scheduling", "Labels and Selectors", "05:47"),
    ("Scheduling", "Practice Test Labels and Selectors", ""),
    ("Scheduling", "Solution: Labels and Selectors", "05:34"),
    ("Scheduling", "Taints and Tolerations", "09:42"),
    ("Scheduling", "Practice Test – Taints and Tolerations", ""),
    ("Scheduling", "Solution – Taints and Toleration (Optional)", "08:02"),
    ("Scheduling", "Node Selectors", "03:19"),
    ("Scheduling", "Node Affinity", "07:16"),
    ("Scheduling", "Practice Test – Node Affinity", ""),
    ("Scheduling", "Solution – Node Affinity (Optional)", "07:27"),
    ("Scheduling", "Taints and Tolerations vs Node Affinity", "02:32"),
    ("Scheduling", "Resource Limits", "14:51"),
    ("Scheduling", "A quick note on editing PODs and Deployments", ""),
    ("Scheduling", "Practice Test Resource Limits", ""),
    ("Scheduling", "Solution: Resource Limits", "05:09"),
    ("Scheduling", "DaemonSets", "04:08"),
    ("Scheduling", "Practice Test DaemonSets", ""),
    ("Scheduling", "Solution: DaemonSets (optional)", "05:44"),
    ("Scheduling", "Static Pods", "08:45"),
    ("Scheduling", "Practice Test – Static Pods", ""),
    ("Scheduling", "Solution – Static Pods (Optional)", "05:58"),
    ("Scheduling", "Multiple Schedulers", "09:32"),
    ("Scheduling", "Practice Test Multiple Schedulers", ""),
    ("Scheduling", "Solution – Multiple Scheduler", "07:46"),
    ("Scheduling", "Configuring Scheduler Profiles", "09:53"),
    ("Scheduling", "References", ""),
    ("Scheduling", "Download Presentation Deck 2", ""),
    ("Scheduling", "(2025 Updates) Admission Controllers", "08:07"),
    ("Scheduling", "(2025 Updates) Practice Test – Admission Controllers", ""),
    ("Scheduling", "(2025 Updates) Solution: Admission Controllers", "06:41"),
    ("Scheduling", "(2025 Updates) Validating and Mutating Admission Controllers", "10:26"),
    ("Scheduling", "(2025 Updates) Practice Test – Validating and Mutating Admission Controllers", ""),
    ("Scheduling", "(2025 Updates) Solution: Validating and Mutating Admission Controllers", "07:39"),
    ...
    # === HELM BASICS (11 topics) ===
    ("Helm Basics", "What is Helm", "06:33"),
    ("Helm Basics", "Installation and configuration", "01:25"),
    ("Helm Basics", "Lab: Installing Helm", ""),
    ("Helm Basics", "A quick note about Helm2 vs Helm3", "08:09"),
    ("Helm Basics", "Helm Components", "07:49"),
    ("Helm Basics", "Helm charts", "07:24"),
    ("Helm Basics", "Working with Helm: basics", "06:16"),
    ("Helm Basics", "Customizing chart parameters", "04:05"),
    ("Helm Basics", "Lab: using Helm to deploy a chart", ""),
    ("Helm Basics", "Lifecycle management with Helm", "07:51"),
    ("Helm Basics", "Lab: upgrading a helm chart", ""),

    # === KUSTOMIZE BASICS (22 topics) ===
    ("Kustomize Basics", "Kustomize Problem Statement & idealogy", "08:03"),
    ("Kustomize Basics", "Kustomize vs Helm", "04:34"),
    ("Kustomize Basics", "Installation/Setup", "01:05"),
    ("Kustomize Basics", "kustomization.yaml file", "03:54"),
    ("Kustomize Basics", "Kustomize Output", "02:31"),
    ("Kustomize Basics", "Kustomize ApiVersion & Kind", "00:22"),
    ("Kustomize Basics", "Managing Directories", "06:18"),
    ("Kustomize Basics", "Managing Directories Demo", "09:21"),
    ("Kustomize Basics", "Lab: Managing Directories", ""),
    ("Kustomize Basics", "Common Transformers", "03:27"),
    ("Kustomize Basics", "Image Transformers", "02:31"),
    ("Kustomize Basics", "Transformers Demo", "11:31"),
    ("Kustomize Basics", "Lab: Transformers", ""),
    ("Kustomize Basics", "Patches Intro", "08:29"),
    ("Kustomize Basics", "Different Types of Patches", "01:13"),
    ("Kustomize Basics", "Patches Dictionary", "06:02"),
    ("Kustomize Basics", "Patches list", "06:21"),
    ("Kustomize Basics", "Lab: Patches", ""),
    ("Kustomize Basics", "Overlays", "05:41"),
    ("Kustomize Basics", "Lab: Overlay", ""),
    ("Kustomize Basics", "Components", "08:44"),
    ("Kustomize Basics", "Lab: Components", ""),
