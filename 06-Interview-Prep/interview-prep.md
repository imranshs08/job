...
| 9 | What is Docker Compose and its use case? | ☐ Low ☐ Med ☐ High |
| 10 | How do you debug a container that keeps crashing? | ☐ Low ☐ Med ☐ High |
...
| 4 | Jenkins declarative vs scripted pipeline | ☐ Low ☐ Med ☐ High |
| 5 | How do you handle secrets in CI/CD pipelines? | ☐ Low ☐ Med ☐ High |
| 6 | What is GitOps and how does ArgoCD implement it? | ☐ Low ☐ Med ☐ High |
| 7 | Explain blue-green vs canary vs rolling deployments | ☐ Low ☐ Med ☐ High |
| 8 | How do you implement automated rollback? | ☐ Low ☐ Med ☐ High |
| 9 | What are Jenkins shared libraries? | ☐ Low ☐ Med ☐ High |
| 10 | How do you set up GitHub Actions for a CI/CD workflow? | ☐ Low ☐ Med ☐ High |
...
| 5 | You need to migrate a monolithic application to microservices. How do you approach it? | |
| 6 | A CI/CD pipeline takes 45 minutes. How do you optimize it? | |
| 7 | You discover a critical vulnerability in a base image used by 20+ services. How do you handle it? | |
